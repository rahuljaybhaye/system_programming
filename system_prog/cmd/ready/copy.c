/** Program  for copy command i.e "cp"  by using command line argument **/
#include<stdio.h>
#include<fcntl.h>	// for  open() and creat() sys call
...
main(int argc,char *argv[])
{
	...
	dfd = creat(argv[2],0664);	//creat() sys call create new file with third argument at command line  i.e. destination file
...
/*copying data from source file to destination file step by step because buffer size is limited
   (every time buffer read new data)  */
